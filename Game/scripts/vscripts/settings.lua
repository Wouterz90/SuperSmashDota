...
if IsInToolsMode() then
  POST_GAME_TIME = 8000
end               -- How long should we let people look at the scoreboard before closing the server automatically?
TREE_REGROW_TIME = 60.0                 -- How long should it take individual trees to respawn after being cut down/destroyed?
ALLY_SELECTION_TIME = 10
ALLY_DISPLAY_TIME = 3

GOLD_PER_TICK = 0                    -- How much gold should players get per tick?
GOLD_TICK_TIME = 1000                      -- How long should we wait in seconds between gold ticks?
...
AUTO_LAUNCH_DELAY = 5                  -- How long should the default team selection launch timer be?  The default for custom games is 30.  Setting to 0 will skip team selection.
